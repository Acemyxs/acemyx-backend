...
2. SCSS:
  a. Replace the files in this folder (/theme/baz/scss/fontawesome) with the files in the scss folder.
  b. Copy the LICENSE.txt file from the root to theme/baz/scss/fontawesome.
  c. Update theme/baz/thirdpartylibs.xml.
