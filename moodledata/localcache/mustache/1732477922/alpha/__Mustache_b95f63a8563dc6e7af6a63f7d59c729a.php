...
class __Mustache_b95f63a8563dc6e7af6a63f7d59c729a extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $indent . '<form class="question-text-format my-2 ml-2" action="';
...
';
        $buffer .= $indent . '        </label>
';
        $buffer .= $indent . '        <select class="form-control custom-select" name="format" id="question-text-format">
';
