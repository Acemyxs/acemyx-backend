...
class __Mustache_e07493b5abafd32c3b09641046b48994 extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->section57893bc715409ea1d5c5377d23318b32($context, $indent, $value);
        $value = $context->findDot('state.hasdiscussions');
        if (empty($value)) {
...
';
    ...
    private function section0f8430ecfbc8799fe0ef4a6ceb7caecd(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
                $buffer .= $indent . '                                    <div class="py-3 pl-0">
';
                $buffer .= $indent . '                                        <div class="d-flex">
';
                $value = $context->findDot('discussion.pinned');
...
';
    ...
    private function section57893bc715409ea1d5c5377d23318b32(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
                        ...
                        $buffer .= $this->section0f8430ecfbc8799fe0ef4a6ceb7caecd($context, $indent, $value);
                        $buffer .= $indent . '                    </tbody>
';
                    }
                    $buffer .= $indent . '                </table>
