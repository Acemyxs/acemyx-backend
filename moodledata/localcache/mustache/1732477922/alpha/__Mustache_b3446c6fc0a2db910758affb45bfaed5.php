...
class __Mustache_b3446c6fc0a2db910758affb45bfaed5 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->section48159a0b2d0a86fff18b75bc8657122c($context, $indent, $value);
        $value = $context->find('displaygroupingselector');
        if (empty($value)) {
...
';
    ...
    private function section48159a0b2d0a86fff18b75bc8657122c(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
