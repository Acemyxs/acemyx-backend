...
class __Mustache_b85ab52b48bdec79e2c251c66e941ff4 extends Mustache_Template
{
...
';
                ...
                $buffer .= $this->sectionB29c5b868248efeb9bc0a1669fbc105a($context, $indent, $value);
                $buffer .= $indent . '
';
...
';
                ...
                $buffer .= $indent . '
';
                $buffer .= $indent . '                    <span class="ml-auto icon expanded-icon" title="';
...
';
                $buffer .= $indent . '                    </span>
';
                $buffer .= $indent . '                    <span class="ml-auto icon collapsed-icon" title="';
                $value = $context->find('str');
...
';
    ...
    private function sectionB29c5b868248efeb9bc0a1669fbc105a(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
    
        if (!is_string($value) && is_callable($value)) {
            $source = '
            <h3 class="sectionname course-content-item d-flex align-self-stretch align-items-center mb-0 pl-2 w-100"
            ...
            foreach ($values as $value) {
                ...
                $buffer .= $indent . '            <h3 class="sectionname course-content-item d-flex align-self-stretch align-items-center mb-0 pl-2 w-100"
';
                $buffer .= $indent . '                id="sectionid-';
                $value = $this->resolveValue($context->find('id'), $context);
                $buffer .= ($value === null ? '' : call_user_func($this->mustache->getEscape(), $value));
