...
class __Mustache_cf2ab7452eee42ae71864a822d9fecfa extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= '">
';
        $buffer .= $indent . '    <div class="form-check d-flex custom-control custom-switch">
';
...
';
        ...
        $value = $this->resolveValue($context->findDot('element.name'), $context);
        $buffer .= ($value === null ? '' : call_user_func($this->mustache->getEscape(), $value));
        $buffer .= '" class="form-check-input custom-control-input ';
        $value = $this->resolveValue($context->findDot('element.extraclasses'), $context);
        $buffer .= ($value === null ? '' : call_user_func($this->mustache->getEscape(), $value));
        $buffer .= '"
';
...
';
        ...
        $buffer .= $this->sectionD7d1ea24a1167699106c88ee673f4f18($context, $indent, $value);
        $buffer .= $indent . '        ';
...
';
    ...
    private function sectionD7d1ea24a1167699106c88ee673f4f18(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
