...
class __Mustache_0815864345411f25f778d3ea4a22914e extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->section7cf19b1688b24c7a46003aa3c28e0e90($context, $indent, $value);
        $buffer .= $indent . '        </div>
';
...
';
    ...
    private function section054cad11da2a0722a5e8b1fb3f7b48da(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
    ...
    private function sectionA945b204a17b9e0c2ddefa7b8f97b9fd(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        ...
        if (!is_string($value) && is_callable($value)) {
            $source = '
                <div class="mb-2">
                    <div class="row mb-1 mx-0 rounded border p-2">
                        <div class="col-6">
...
';
                $buffer .= $indent . '                    <div class="row mb-1 mx-0 rounded border p-2">
';
                $buffer .= $indent . '                        <div class="col-6">
';
...
';
                $buffer .= $indent . '                            <div class="col-sm-1 pl-0">
';
                $value = $context->findDot('completionstatus.icon');
                $buffer .= $this->section054cad11da2a0722a5e8b1fb3f7b48da($context, $indent, $value);
                $value = $context->findDot('completionstatus.icon');
                if (empty($value)) {
...
';
                ...
                $buffer .= $indent . '                            </div>
';
                $buffer .= $indent . '                            <div class="col-sm-11 pl-0">
';
...
';
    ...
    private function section7cf19b1688b24c7a46003aa3c28e0e90(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        ...
        if (!is_string($value) && is_callable($value)) {
            ...
            foreach ($values as $value) {
                ...
                $buffer .= $this->sectionA945b204a17b9e0c2ddefa7b8f97b9fd($context, $indent, $value);
                $context->pop();
            }
        }
