...
class __Mustache_11113eb32c6eab62941f0dd7b2670d42 extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->section0874ad60bd5eaecaf055d322c4cb85d0($context, $indent, $value);
        $buffer .= $indent . '
';
...
';
    ...
    private function section0874ad60bd5eaecaf055d322c4cb85d0(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
<div class="float-left">
    <a href="{{pluginbaseurl}}/user_evidence_list.php?userid={{userid}}" class="btn btn-primary">{{#str}}userevidence, tool_lp{{/str}}</a>
</div>
';
            $result = (string) call_user_func($value, $source, $this->lambdaHelper);
            $buffer .= $result;
