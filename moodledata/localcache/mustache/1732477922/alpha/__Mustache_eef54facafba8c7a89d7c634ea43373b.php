...
class __Mustache_eef54facafba8c7a89d7c634ea43373b extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->section399ddb813ab4a19d996a7ea8c1253722($context, $indent, $value);
        $buffer .= $indent . '</ul>
';
...
';
    ...
    private function sectionC489d6961865df0772d7c6897b1cde5f(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
    ...
    private function section399ddb813ab4a19d996a7ea8c1253722(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
    ...
    ';
            ...
            foreach ($values as $value) {
                ...
                $value = $context->find('visible');
                $buffer .= $this->sectionC489d6961865df0772d7c6897b1cde5f($context, $indent, $value);
                $context->pop();
            }
        }
