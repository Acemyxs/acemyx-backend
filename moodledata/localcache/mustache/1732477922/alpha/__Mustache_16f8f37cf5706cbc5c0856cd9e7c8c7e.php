...
class __Mustache_16f8f37cf5706cbc5c0856cd9e7c8c7e extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->section49760807110c5bf3619f40cc9a30347f($context, $indent, $value);
        $buffer .= $indent . '<div class="rui-contentbank-view-btns">
';
        $buffer .= $indent . '    <button class="rui-icon-no-margin btn btn-sm btn-secondary ';
...
';
    ...
    private function section49760807110c5bf3619f40cc9a30347f(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
    ...
    {{/dropdown}}
    {{^dropdown}}
        <a href="{{ link }}" class="rui-icon-no-margin btn btn-sm btn-secondary" title="{{ name }}" data-action="{{ action }}">
            <span class="mr-2">
...
';
            ...
            foreach ($values as $value) {
                ...
                if (empty($value)) {
                    ...
                    $buffer .= '" class="rui-icon-no-margin btn btn-sm btn-secondary" title="';
