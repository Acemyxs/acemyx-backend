...
class __Mustache_11aea555efef1853d398e0d376296426 extends Mustache_Template
{
...
';
        $buffer .= $indent . '        <div class="cta-icon mr-2 icon-size-5 flex-shrink-0">
';
        $buffer .= $indent . '            ';
...
';
        $buffer .= $indent . '        </div>
';
        $buffer .= $indent . '        <div class="align-self-center flex-grow-1">
';
        $buffer .= $indent . '            ';
