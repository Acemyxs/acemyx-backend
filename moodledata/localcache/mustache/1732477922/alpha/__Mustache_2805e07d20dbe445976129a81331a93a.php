...
class __Mustache_2805e07d20dbe445976129a81331a93a extends Mustache_Template
{
...
';
        ...
        $buffer .= '</legend>
';
        $buffer .= $indent . '        <div class="border-radius border d-flex flex-column flex-md-row align-items-center mx-0 my-2 py-1 pl-3 pr-2 row">
';
...
';
        ...
        $buffer .= '" class="mr-md-2 mb-md-0 label-sm">';
        $value = $context->find('str');
        $buffer .= $this->section043761c7993201193b2b1d79ec0dd03a($context, $indent, $value);
        $buffer .= '</label>
';
        $buffer .= $indent . '                <select class="custom-select mr-md-2" data-filterfield="join" id="core-filter_row-jointype-';
        $value = $this->resolveValue($context->find('uniqid'), $context);
        $buffer .= ($value === null ? '' : call_user_func($this->mustache->getEscape(), $value));
        $buffer .= '">
';
...
';
        ...
        $buffer .= '</label>
';
        $buffer .= $indent . '            <select class="custom-select mr-md-2" data-filterfield="type" id="core-filter_row-filtertype-';
        $value = $this->resolveValue($context->find('uniqid'), $context);
        $buffer .= ($value === null ? '' : call_user_func($this->mustache->getEscape(), $value));
        $buffer .= '">
';
...
';
        $buffer .= $indent . '
';
        $buffer .= $indent . '            <div data-filterregion="value" class="d-block flex-column align-items-center flex-lg-row my-1"></div>
';
        $buffer .= $indent . '
';
        $buffer .= $indent . '            <button data-filteraction="remove" class="ml-auto btn btn-sm btn-icon btn-danger mr-0 my-1" aria-label="';
        $value = $context->find('str');
