...
class __Mustache_09d6edf4d3547c8fc10eaa0792706ea8 extends Mustache_Template
{
...
';
        $buffer .= $indent . '                            <div ';
        $value = $context->find('hasblocks');
        $buffer .= $this->section6e5e66fd64d8acc7887a12d0cdfde262($context, $indent, $value);
        $buffer .= '>
';
        $buffer .= $indent . '                                <div ';
        $value = $context->find('hasblocks');
...
';
    ...
    private function section6e5e66fd64d8acc7887a12d0cdfde262(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
