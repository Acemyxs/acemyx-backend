...
class __Mustache_db924a9b03bb1f19778aed22eeb89b89 extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->sectionF1e19b30c995b40faf9f7d91b27c9905($context, $indent, $value);
        $buffer .= $indent . '                                    ';
...
';
    ...
    private function sectionF1e19b30c995b40faf9f7d91b27c9905(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
    
        if (!is_string($value) && is_callable($value)) {
            $source = '
                                        <div class="container-fluid tertiary-navigation px-0">
                                            <div class="navitem">
                                                {{> core/url_select}}
                                            </div>
                                        </div>
            ...
            foreach ($values as $value) {
                ...
                $buffer .= $indent . '                                        <div class="container-fluid tertiary-navigation px-0">
';
