...
class __Mustache_35624e54149f97402c49afceef538790 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $indent . '<div class="completion-dialog p-2">
';
        $value = $context->find('hasconditions');
        $buffer .= $this->sectionFbed263d0028d73902e66081bc235025($context, $indent, $value);
        $buffer .= $indent . '
';
        $value = $context->find('hasconditions');
        if (empty($value)) {
...
';
        ...
        $buffer .= $this->section3df557238684b88015a51b6033c08821($context, $indent, $value);
        $buffer .= $indent . '</div>
';
...
';
    ...
    private function sectionF5339e870b9f4adb4c9dc8f3b1fb38f4(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        ...
        if (!is_string($value) && is_callable($value)) {
            ...
            foreach ($values as $value) {
                ...
                $buffer .= $indent . '                    <div class="d-flex mt-2 align-items-center" role="listitem" ';
...
';
    ...
    private function sectionDd31a071310ccc9e159052fde2d58b83(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        ...
        if (!is_string($value) && is_callable($value)) {
            ...
            foreach ($values as $value) {
                ...
                $buffer .= $indent . '                    <div class="d-flex mt-2 align-items-center text-danger" role="listitem" ';
                $value = $context->find('accessibledescription');
                $buffer .= $this->sectionE1e1ed08cf218e44355173df914a0f1f($context, $indent, $value);
                $buffer .= '>
';
...
';
    ...
    private function sectionE7f5bf3e0f3c438f0eeac88e3c30b6b1(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
    ...
    private function sectionAca8792ccc3e0f64dfe0eba555de29a7(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        ...
        if (!is_string($value) && is_callable($value)) {
            ...
            foreach ($values as $value) {
                ...
                $buffer .= $this->sectionF5339e870b9f4adb4c9dc8f3b1fb38f4($context, $indent, $value);
                $value = $context->find('statuscompletefail');
                $buffer .= $this->sectionDd31a071310ccc9e159052fde2d58b83($context, $indent, $value);
                $value = $context->find('statusincomplete');
                $buffer .= $this->sectionE7f5bf3e0f3c438f0eeac88e3c30b6b1($context, $indent, $value);
                $context->pop();
            }
        }
    ...
    private function section09765a6b46ea0dc8c0455d170b638afc(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        ...
        if (!is_string($value) && is_callable($value)) {
            ...
            foreach ($values as $value) {
                ...
                $value = $context->find('istrackeduser');
                $buffer .= $this->sectionAca8792ccc3e0f64dfe0eba555de29a7($context, $indent, $value);
                $buffer .= $indent . '
';
                $value = $context->find('istrackeduser');
                if (empty($value)) {
...
';
    ...
    private function sectionFbed263d0028d73902e66081bc235025(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
                ...
                $buffer .= $indent . '
';
                $buffer .= $indent . '        <div role="list">
';
                $value = $context->find('completiondetails');
                $buffer .= $this->section09765a6b46ea0dc8c0455d170b638afc($context, $indent, $value);
                $buffer .= $indent . '
';
...
';
    ...
    private function section2bd490077e2a62be38a4c0368339991e(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        ...
        ';
            ...
            foreach ($values as $value) {
                ...
                $buffer .= $indent . '            <div class="editcompletion border-top mt-3 pt-3">
';
                $buffer .= $indent . '                <a href="';
                $value = $this->resolveValue($context->find('editurl'), $context);
                $buffer .= ($value === null ? '' : call_user_func($this->mustache->getEscape(), $value));
                $buffer .= '" class="btn btn-sm">
';
                $buffer .= $indent . '                    ';
                $value = $context->find('hasconditions');
...
';
    ...
    private function section3df557238684b88015a51b6033c08821(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
    ...
    ';
            ...
            foreach ($values as $value) {
                ...
                $buffer .= $this->section2bd490077e2a62be38a4c0368339991e($context, $indent, $value);
                $context->pop();
            }
        }
